package be.phw.gedclient.repository;

import be.phw.gedclient.GedclientApp;
import be.phw.gedclient.config.Constants;
import be.phw.gedclient.config.audit.AuditEventConverter;
import be.phw.gedclient.domain.PersistentAuditEvent;
...
import static be.phw.gedclient.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
